    ...
    return(
        <div className="cards-section">
            <div className="cards-title">
                ...
                <h1>De eerste zes redenen om bij ons te werken</h1>
            </div>
            <div className="cards">
                {cardContent.map(card => (
                    <Card id={card.id} title={card.title} content={card.content} backgroundColor={card.backgroundColor} color={card.color} className='card'/>
                ))}
            </div>
