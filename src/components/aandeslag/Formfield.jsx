...
export default function Formfield(){
    return (
        <div className="form-field-container">
                ...
                <form action="">
                <div className="info">
                <InputField title="Naam*" htmlFor="firstName" type="text" id="firstName"className="input-field"></InputField>
                <InputField title="Achternaam" htmlFor="lastName" type="text" id="lastName" className="input-field"></InputField>
                <InputField title="Telefoonnummer" htmlFor="telefoonnummer" type="text" id="tel" className="input-field"></InputField>
                <InputField title="Email*" htmlFor="email" type="text" id="email" className="input-field"></InputField>
                </div>
